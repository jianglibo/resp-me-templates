(function(e, t) {
    ...
    class a {
        ...
        requireElement(e, t, r, n) {
            ...
            if (!i)
                a.raiseParseError(t, r || "Expected " + e);
            return i
        }
        parseAnyOf(e, t) {
    ...
    function T(t) {
        ...
        function g(e, t, r) {
            ...
            if (r.matchToken("inclusive"))
                n.includeEnd = true;
            else if (r.matchToken("exclusive"))
        ...
        function S(e, t) {
            ...
            if (e.matchToken("json") || e.matchToken("Object")) {
                ...
                r = "html"
            } else if (e.matchToken("text")) {} else {
            ...
            var u = {
                ...
                op: function(e, r, n) {
                    ...
                    return fetch(r, n).then((function(r) {
                        ...
                        t.triggerEvent(e.me, "fetch:error", {
                            reason: r
                        });
                        throw r
                    }
            ...
            return {
                ...
                op: function(e, r) {
                    ...
                    t.forEach(i, (function(t) {
                        if (t in e.result)
                            e.locals[t] = e.result[t];
                        else
                            throw "No such measurement as " + t
                    }
                    ));
                    return t.findNext(this, e)
                }
